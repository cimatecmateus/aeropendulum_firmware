#ifndef _ROS_aeropendulum_common_messages_StepResponseData_h
#define _ROS_aeropendulum_common_messages_StepResponseData_h
...
namespace aeropendulum_common_messages
{
  ...
  class StepResponseData : public ros::Msg
  {
    public:
      float angle;
      uint32_t nSample;
    ...
    const char * getType(){ return "aeropendulum_common_messages/StepResponseData"; };
